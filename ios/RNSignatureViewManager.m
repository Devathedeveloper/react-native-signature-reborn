...
RCT_EXPORT_VIEW_PROPERTY(signingAnimationEnabled, BOOL)
RCT_EXPORT_VIEW_PROPERTY(signingAnimationColor, UIColor)
RCT_EXPORT_VIEW_PROPERTY(signingAnimationDuration, NSNumber)
RCT_EXPORT_VIEW_PROPERTY(signingAnimationRadiusMultiplier, NSNumber)
